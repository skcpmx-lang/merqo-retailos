...
export const SEED_PERMISSIONS = [
  ...
  // Finance - granular per Phase 3D spec
  { code: 'finance.view', name: 'View Finance Dashboard', nameBn: 'ফাইন্যান্স ড্যাশবোর্ড দেখুন', module: 'finance' },
  ...
  { code: 'finance.account.view', name: 'View Accounts', nameBn: 'হিসাব দেখুন', module: 'finance' },
  { code: 'finance.account.create', name: 'Create Account', nameBn: 'হিসাব তৈরি', module: 'finance' },
  { code: 'finance.account.update', name: 'Update Account', nameBn: 'হিসাব আপডেট', module: 'finance' },
  { code: 'finance.account.deactivate', name: 'Deactivate Account', nameBn: 'হিসাব নিষ্ক্রিয়', module: 'finance' },
  { code: 'finance.transaction.view', name: 'View Transactions', nameBn: 'লেনদেন দেখুন', module: 'finance' },
  { code: 'finance.transaction.create', name: 'Create Transaction', nameBn: 'লেনদেন তৈরি', module: 'finance' },
  { code: 'finance.expense.create', name: 'Create Expense', nameBn: 'খরচ তৈরি', module: 'finance' },
  { code: 'finance.expense.void', name: 'Void Expense', nameBn: 'খরচ বাতিল', module: 'finance' },
  { code: 'finance.transfer', name: 'Transfer Funds', nameBn: 'অর্থ স্থানান্তর', module: 'finance' },
  { code: 'finance.reconcile', name: 'Reconcile Accounts', nameBn: 'হিসাব সমন্বয়', module: 'finance' },
  { code: 'finance.shift.open', name: 'Open Shift', nameBn: 'শিফট খুলুন', module: 'finance' },
  { code: 'finance.shift.close', name: 'Close Shift', nameBn: 'শিফট বন্ধ', module: 'finance' },
  { code: 'finance.shift.adjustment', name: 'Shift Adjustment', nameBn: 'শিফট সমন্বয়', module: 'finance' },
  { code: 'finance.shift.view', name: 'View Shifts', nameBn: 'শিফট দেখুন', module: 'finance' },
  { code: 'finance.view_sensitive', name: 'View Sensitive Data', nameBn: 'সংবেদনশীল তথ্য দেখুন', module: 'finance' },
